    ...
    return function()
      {
        ...
        {
          this.UnitSkybox = new unit_skybox("../assets/textures/skybox/starry/", ".bmp");
          ...
          var queen = new char().CreateQueen(0.1, dark_transparent_material);
          queen.Mesh.position.x = 0.15;
          queen.Mesh.position.z = -0.15;
          this.King = new char().CreateKing(0.1, dark_transparent_material);
          this.King.Mesh.position.x = -0.15;
          this.King.Mesh.position.z = -0.15;

          var slayers = [];
          slayers.push(new char().CreateSlayer(0.1, dark_transparent_material));
          ...
          var mages = [];
          mages.push(new char().CreateMage(0.1, dark_transparent_material));
          ...
          var knights = [];
          knights.push(new char().CreateKnight(0.1, dark_transparent_material));
          ...
          {
            pawns.push(new char().CreatePawn(0.1, dark_transparent_material));
            pawns[pawns.length - 1].Mesh.position.x = i;
            pawns[pawns.length - 1].Mesh.position.z = 0.15;
          }

          var towers = [];
          towers.push(new char().CreateTower(0.1, dark_transparent_material));
          ...
          var base = new sprim().CreatePlane(10, 10, new THREE.MeshPhysicalMaterial(
            {
              color: 0x333333
            }));
