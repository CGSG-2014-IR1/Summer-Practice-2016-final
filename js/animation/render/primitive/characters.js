function CreateQueen( Scale, Material )
{
  var ret = new prim();
...
function CreateKing( Scale, Material )
{
  Scale *= 1.1;
  var ret = new prim();
  var m = new THREE.Matrix4();
...
function CreatePawn( Scale, Material )
{
  Scale *= 0.75;
  var ret = new prim();
  var m = new THREE.Matrix4();
...
function CreateTower( Scale, Material )
{
  Scale *= 1.2;
  var ret = new prim();
  var m = new THREE.Matrix4();
...
function CreateSlayer( Scale, Material )
{
  Scale *= 0.9;
  var ret = new prim();
  var m = new THREE.Matrix4();
...
function CreateMage( Scale, Material )
{
  var ret = new prim();
  var m = new THREE.Matrix4();
  ret.Geometry = new THREE.SphereGeometry(Scale, 15, 15);
...
function CreateKnight( Scale, Material )
{
  var ret = new prim();
  var m = new THREE.Matrix4();
