define(['prim/prim', 'res/material'], function(prim, material)
  {
    return function()
      {
        this.CreatePlane = function( du, dv, Material )
        {
          if (!du)
            du = 1.0;
          if (!dv)
        ...
        this.CreateBox = function( sx, sy, sz, Material )
        {
          if (!sx)
            sx = 1.0;
          if (!sy)
        ...
        this.CreateSphere = function( r, segmh, segmv, Material )
        {
          if (!r)
            r = 1.0;
          if (!segmh)
        ...
        this.CreateSkybox = function(Path, Format)
        {
          if (!Path || !Format)
